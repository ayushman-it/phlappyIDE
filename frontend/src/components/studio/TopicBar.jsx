      ...
      <div className="bg-slate-50/90 border-b border-slate-200 text-slate-800 px-6 py-1.5 flex items-center justify-between shadow-xs select-none">
        <div className="flex items-center space-x-3 flex-1 max-w-2xl">
          <button
            ...
            className="flex items-center space-x-2 bg-white hover:bg-slate-100 text-slate-700 px-3.5 py-1 rounded-lg border border-slate-200 text-xs font-semibold w-full transition-all cursor-pointer shadow-2xs"
          >
        ...
        <div className="flex items-center space-x-2">
          <button
            onClick={() => setIsExpanded(true)}
            className="flex items-center space-x-1 text-slate-600 hover:text-slate-900 text-[11px] font-semibold px-2 py-1 rounded-lg bg-white hover:bg-slate-100 border border-slate-200 cursor-pointer shadow-2xs"
          >
